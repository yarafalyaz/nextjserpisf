...
async function main() {
  ...
  try {
    ...
    const permissions = [
      ...
      "create_item_categories", "edit_item_categories", "delete_item_categories",
      "view_brands", "create_brands", "edit_brands", "delete_brands",
      "view_barcodes", "create_barcodes", "edit_barcodes", "delete_barcodes",
      "view_currencies", "create_currencies", "edit_currencies", "delete_currencies",
      "view_payment_terms", "create_payment_terms", "edit_payment_terms", "delete_payment_terms",
      ...
      "view_quotations", "create_quotations", "edit_quotations", "delete_quotations", "confirm_quotations", "approve_quotations",
      "view_sales_orders", "create_sales_orders", "edit_sales_orders", "delete_sales_orders", "approve_sales_orders",
      "view_sales_invoices", "create_sales_invoices", "post_sales_invoices", "delete_sales_invoices", "approve_sales_invoices",
      "view_sales_payments", "create_sales_payments", "delete_sales_payments",
      "view_sales_returns", "create_sales_returns", "edit_sales_returns", "delete_sales_returns",
      "view_down_payments", "create_down_payments", "edit_down_payments", "confirm_down_payments", "delete_down_payments",
      ...
      "view_stock_moves",
      "view_stock_adjustments", "create_stock_adjustments", "edit_stock_adjustments", "process_stock_adjustments", "delete_stock_adjustments",
      "view_inventory_transfers", "create_inventory_transfers", "edit_inventory_transfers", "delete_inventory_transfers",
      "view_material_issues", "create_material_issues", "edit_material_issues", "delete_material_issues",
      "view_work_orders", "create_work_orders", "edit_work_orders", "complete_work_orders", "delete_work_orders",
      "view_work_schedules", "create_work_schedules", "delete_work_schedules",
      "view_attendance", "create_attendance", "edit_attendance", "manage_attendance",
      "view_leave_requests", "create_leave_requests", "edit_leave_requests", "approve_leave_requests", "delete_leave_requests",
      "view_overtime", "create_overtime_requests", "edit_overtime_requests", "approve_overtime", "approve_overtime_requests", "delete_overtime_requests",
      "view_payroll", "create_payroll", "edit_payroll", "process_payroll", "update_payroll",
      "view_journals", "create_journals", "edit_journals", "post_journals", "delete_journals",
      "view_expenses", "create_expenses", "edit_expenses", "approve_expenses", "delete_expenses",
      "view_petty_cash", "create_petty_cash", "delete_petty_cash",
      ...
      "view_assets", "create_assets", "manage_assets", "delete_assets",
      "view_appreciations", "create_appreciations", "delete_appreciations",
      "create_asset_brands", "delete_asset_brands",
      "create_asset_categories", "delete_asset_categories",
      "create_asset_transfers", "delete_asset_transfers",
      "view_vehicles", "create_vehicles", "edit_vehicles", "delete_vehicles",
      "create_vehicle_brands", "edit_vehicle_brands", "delete_vehicle_brands",
      "create_vehicle_models", "edit_vehicle_models", "delete_vehicle_models",
      "view_projects", "create_projects", "edit_projects", "delete_projects",
      "view_budgets", "create_budgets", "delete_budgets",
      "view_cost_centers", "create_cost_centers", "edit_cost_centers", "delete_cost_centers",
      "create_departments", "edit_departments", "delete_departments",
      "create_positions", "edit_positions", "delete_positions",
      "create_banks", "edit_banks", "delete_banks",
      ...
      "create_taxes", "edit_taxes", "delete_taxes",
      "create_holidays", "delete_holidays",
      "create_loans", "delete_loans",
      "create_products", "edit_products", "delete_products",
      "create_production_orders", "delete_production_orders",
      "view_employee_loans",
    ...
    const adminEmail = process.env.SEED_ADMIN_EMAIL || "admin@yaraerp.co.id"
    ...
    const [adminUser] = await conn.query("SELECT id FROM users WHERE email = ?", [adminEmail])
    await conn.query(
    ...
    for (const [code, name] of departments) {
      const existingDept = await conn.query("SELECT id FROM departments WHERE name = ? LIMIT 1", [name])
      ...
      const dept = await conn.query("SELECT id FROM departments WHERE name = ? LIMIT 1", [name])
    ...
    for (const [code, name, deptName] of positions) {
      ...
      const existingPos = await conn.query("SELECT id FROM positions WHERE name = ? LIMIT 1", [name])
