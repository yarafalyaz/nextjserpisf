...
export function AssetTransferForm({
  ...
  const [fromEmployeeId, setFromEmployeeId] = useState(
    transfer?.fromEmployeeId ? String(transfer.fromEmployeeId) : "",
  );
  ...
  function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    startTransition(async () => {
      try {
        ...
        const { createAssetTransfer, updateAssetTransfer } =
          await import("@/actions/asset.actions");
        const result = transfer?.id
        ...
        <FormSection title="Detail Transfer">
          <div className="flex flex-col gap-1.5">
            ...
            <Input
              ...
              name="fromLocation"
              defaultValue={
                transfer?.fromLocation ?? selectedAsset?.location ?? ""
              }
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <Input
              id="toLocation"
              name="toLocation"
              defaultValue={transfer?.toLocation ?? ""}
