...
import { Input, TextArea, Label, Select, ComboBox, ListBox, InputGroup } from "@heroui/react"
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="bg-surface rounded-xl border border-default shadow-sm p-6">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <InputGroup>
            ...
            <InputGroup.Input id="cost" type="number" step="0.01" {...register("cost", { valueAsNumber: true })} placeholder="0" />
          </InputGroup>
        </div>
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <InputGroup>
            <InputGroup.Prefix>Rp</InputGroup.Prefix>
            <InputGroup.Input id="price" type="number" step="0.01" {...register("price", { valueAsNumber: true })} placeholder="0" />
          </InputGroup>
        </div>
      ...
      <div className="flex justify-end gap-3 mt-6 pt-5 border-t border-default">
        ...
        <button type="submit" disabled={isPending || uploading} className="inline-flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-lg text-sm font-medium bg-primary text-white hover:bg-primary-hover hover:-translate-y-px hover:shadow-md transition-all">
