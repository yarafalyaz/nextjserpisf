  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        ...
        <Link
          href="/keuangan/rekonsiliasi-bank/tambah"
              ...
              {reconciliations.length === 0 ? (
                ...
                reconciliations.map((r) => (
                  <DetailTableRow key={r.id}>
                    ...
                    <DetailTableTd>
                      {r.items.filter((i) => i.matched).length} /{" "}
                      {r.items.length}
                    </DetailTableTd>
                    <DetailTableTd>
                    ...
                    <DetailTableTd>
                      <Link
                        href={`/keuangan/rekonsiliasi-bank/${r.id}`}
        ...
        {totalPages > 1 && (
          <div className="flex items-center justify-between p-3 px-5 border-t border-default">
            ...
            <div className="flex gap-1">
              {page > 1 && (
                <Link
                  href={`/keuangan/rekonsiliasi-bank?halaman=${page - 1}`}
                  className="button button--ghost button--sm"
                >
                  ← Sebelumnya
                </Link>
