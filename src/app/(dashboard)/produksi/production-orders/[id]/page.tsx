...
export default async function ProductionOrderDetailPage({
  ...
  <div className="flex gap-2">
          <Link href={`/produksi/production-orders/${order.id}/edit`} className="inline-flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-lg text-sm font-medium bg-primary text-white hover:bg-primary-hover hover:-translate-y-px hover:shadow-md transition-all">Edit</Link>
