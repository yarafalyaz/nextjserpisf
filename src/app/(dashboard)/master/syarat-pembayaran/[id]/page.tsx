...
export default async function PaymentTermDetailPage({
  ...
  { label: paymentTerm.name },
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        ...
        <Link href={`/master/syarat-pembayaran/${paymentTerm.id}/ubah`} className="inline-flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-lg text-sm font-medium bg-primary text-white hover:bg-primary-hover hover:-translate-y-px hover:shadow-md transition-all">
          Ubah
        </Link>
      </div>
