  ...
  return (
    <div className="flex flex-col gap-6">
      <AppBreadcrumbs items={[
        ...
        { label: "Master Data", href: "/master/tax-groups" },
        { label: "Tax Group", href: "/master/tax-groups" },
        { label: "Detail" },
      ]} />
      <div className="flex items-center justify-between flex-wrap gap-4">
        <h1 className="text-2xl font-bold text-foreground">Detail Tax Group</h1>
        <Link href={`/master/tax-groups/${data.id}/edit`} className="inline-flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-lg text-sm font-medium bg-primary text-white hover:bg-primary-hover hover:-translate-y-px hover:shadow-md transition-all">
          Edit
        </Link>
      </div>
