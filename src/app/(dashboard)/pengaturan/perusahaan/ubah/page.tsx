  ...
  return (
    <div className="flex flex-col gap-6 px-4 lg:px-6">
      <AppBreadcrumbs items={[
        ...
        { label: "Perusahaan", href: "/pengaturan/perusahaan" },
        { label: "Ubah" },
      ]} />
      <h1 className="text-2xl font-bold text-foreground">Ubah Informasi Perusahaan</h1>
      <SettingsEditForm settings={settings} accounts={accounts} section="company" redirectTo="/pengaturan/perusahaan" />
    </div>
  )
}
