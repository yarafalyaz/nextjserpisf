...
export default async function AssetCategoriesPage({
  ...
  { label: "Categories" },
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        ...
        <Link href="/assets/categories/create" className="inline-flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-lg text-sm font-medium bg-primary text-white hover:bg-primary-hover hover:-translate-y-px hover:shadow-md transition-all" id="create-asset-cat-btn">
          + Tambah Kategori
        </Link>
      </div>
      ...
      <div className="bg-surface rounded-xl border border-default shadow-sm overflow-hidden">
        <div className="p-3 px-4 flex flex-col gap-3">
          <AppSearchField placeholder="Cari nama kategori..." action="/assets/categories" />
        </div>
