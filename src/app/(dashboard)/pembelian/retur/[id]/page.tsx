    ...
    <div className="flex flex-col gap-6">
      ...
      <DetailCard>
        ...
        <DetailField
          ...
          value={<Link href={`/purchase/orders/${purchaseReturn.purchaseOrder.id}`}>{purchaseReturn.purchaseOrder.documentNo}</Link>}
        />
        <DetailField
          label="Vendor"
          value={<Link href={`/master/vendors/${purchaseReturn.purchaseOrder.vendor.id}`}>{purchaseReturn.purchaseOrder.vendor.name}</Link>}
        />
